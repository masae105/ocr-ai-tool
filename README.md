...
クラウドワークスや求人情報を見ている中で、データ入力や書類の転記作業など、手作業で行われている業務が多くあることに気付きました。Python学習を進める中で、学んだ知識を実際の業務でどのように活用できるのかを考え、
PythonとOCR技術を利用して、画像やPDFから必要な情報を取得し、Excelで利用できるデータへ変換する仕組みを開発しました。
